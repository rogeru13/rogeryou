      ...
      <div className="flex flex-col md:flex-row w-full max-w-5xl mx-auto pt-8 pb-16 px-2 md:px-6 flex-1">
        ...
        <div className="flex-1 flex flex-col justify-center items-start md:pl-12">
          ...
          <div className="space-y-3 text-sm text-black/60 mb-6">
            ...
            <div>i&#39;ve worked on products at <a href="https://www.linkedin.com/company/trypearai/" className="text-emerald-600 relative group" target="_blank" rel="noopener noreferrer">PearAI<span className="absolute left-0 -bottom-0.5 w-full h-[2px] bg-emerald-600 scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left rounded" aria-hidden="true" /></a> (YC24) and <a href="https://www.springcarnival.org/" className="text-emerald-600 relative group" target="_blank" rel="noopener noreferrer">Spring Carnival<span className="absolute left-0 -bottom-0.5 w-full h-[2px] bg-emerald-600 scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left rounded" aria-hidden="true" /></a>, and published research at <a href="https://research-innovation.ncssm.edu/research-communication/durham-summer-ri-showcase/srip-showcase-2023/all-2023-projects" className="text-emerald-600 relative group">NC State<span className="absolute left-0 -bottom-0.5 w-full h-[2px] bg-emerald-600 scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left rounded" aria-hidden="true" /></a> and <a href="https://openreview.net/forum?id=nWCsJdKoUs" className="text-emerald-600 relative group">ICML<span className="absolute left-0 -bottom-0.5 w-full h-[2px] bg-emerald-600 scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left rounded" aria-hidden="true" /></a>. </div>
            <div style={{ padding: '.05rem' }}></div>
